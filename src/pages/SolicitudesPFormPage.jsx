...
const SolicitudesPFormPage = () => {
    ...
    const handleSubmit = (event) => {
        ...
        SolicitudesPService.addSolicitudesP(idPaciente, descripcion).then(response => {
        ...
        <div>
            ...
            <Container className='bg-dark'>
                    <Col sm="12" md={{ size: 7, offset: 4 }}>
                        <h2 className="text-white"> </h2>
                        <h2 className="text-white"> Solicitar un pabellón </h2>
                    </Col>
                <Container>
                    <Form>
...
export default SolicitudesPFormPage;